...
1.	First locate the transmitter box (base), it’s usually inconveniently high up on a wall. It’s about 5 inches tall, 4 inches deep, and 1 inch wide. A picture of the transmitter is included below.
2.	Press and hold the silver button on the front of the transmitter box for 4 seconds, once you release the button, both lights should begin blinking
...
10.	This process might fail if the lights stop blinking on the transmitter before pressing # on the phone. If that’s the case, just try again. The lights usually blink for about 30-40 seconds after pressing the silver button.
